...
public class FollowersResponseBean1 {
    @SerializedName("_id")
    @Expose
    private String id;
    ...
    @Expose
    private FollowersProfileDetailsBean profileDetail;
    ...
    public FollowersProfileDetailsBean getProfileDetail() {
        return profileDetail;
    }

    public void setProfileDetail(FollowersProfileDetailsBean profileDetail) {
