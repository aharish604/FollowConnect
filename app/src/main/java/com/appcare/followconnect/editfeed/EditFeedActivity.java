...
public class EditFeedActivity extends AppCompatActivity implements View.OnClickListener, APIResponse {
    ...
    EditFeedPresenter presenter = null;
    String privicy = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Glide.with(EditFeedActivity.this)
                .load(prfile_url)
        ...
        camera.setOnClickListener(EditFeedActivity.this);
        gallery.setOnClickListener(EditFeedActivity.this);
        imgbtn_searchuserprofile.setOnClickListener(EditFeedActivity.this);
        tv_post.setOnClickListener(EditFeedActivity.this);
        video.setOnClickListener(EditFeedActivity.this);

        final ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(EditFeedActivity.this, android.R.layout.simple_spinner_item, Constants.getPrivacy());
        ...
        presenter = new EditFeedPresenter(EditFeedActivity.this, EditFeedActivity.this);
    ...
    private void validate() {
        ...
        if (selectedImageList.size() != 0 || !et_comment.getText().toString().trim().equalsIgnoreCase("") || selectedVideolist.size() != 0) {
            ...
            String feedId = myIntent.getStringExtra("FEEDID");
            presenter.EditFeedPost(uid, comment, isSpolvid, privicy, feedId, imagesarray, videosarray);

        } else {

            Constants.displayLongToast(EditFeedActivity.this, "Select Something");
    ...
    public String getImageFilePath(Uri contentUri) {
        ...
        try {
            ...
            cursor = EditFeedActivity.this.getContentResolver().query(contentUri, proj, null, null, null);
            ...
            if (requestCode == REQUEST_IMAGE_CAPTURE) {
                ...
                if (data.getClipData() != null) {
                    ...
                    for (int i = 0; i < mClipData.getItemCount(); i++) {
                        ...
                        Uri uri = item.getUri();
                        checkImage(Utility.getFilePathFromURI(EditFeedActivity.this, uri), "image");
                    }
                ...
                Uri uri = data.getData();
                // videopath = Utility.getFilePathFromURI(EditFeedActivity.this, uri);

                checkImage(Utility.getFilePathFromURI(EditFeedActivity.this, uri), "video");
    ...
    public void takePicture() {
        ...
        if (takePictureIntent.resolveActivity(getPackageManager()) != null) {
            ...
            if (photoFile != null) {
                Uri photoURI = FileProvider.getUriForFile(EditFeedActivity.this,
    ...
    private void openHomeActivity() {
        ...
        Intent i = new Intent(EditFeedActivity.this, HomeActivity.class);
    ...
    public void onSuccess(Object object) {
        ...
        Constants.displayLongToast(EditFeedActivity.this, signUpResponse.getMessage());
    ...
    public void onServerError(String error) {
        dismissProgress();
        Constants.displayLongToast(EditFeedActivity.this, error);
    }


    @Override
    public void showProgress() {
        progressDialog = Constants.showProgressDialog(EditFeedActivity.this, "");
    }
    ...
    public void networkError(String error) {
        dismissProgress();
        Constants.displayLongToast(EditFeedActivity.this, error.toString());
